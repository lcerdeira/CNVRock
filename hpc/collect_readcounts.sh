#!/bin/bash
#SBATCH --job-name=kpsc_readcounts
#SBATCH --output=/home/lshlt19/CNVRock/logs/rc_%A_%a.out
#SBATCH --error=/home/lshlt19/CNVRock/logs/rc_%A_%a.err
...
OUT_DIR="$REPO_DIR/models/experiments/21/readcounts"
