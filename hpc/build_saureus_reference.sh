#!/bin/bash
#SBATCH --job-name=saureus_ref
#SBATCH --output=/home/lshlt19/CNVRock/logs/saureus_ref_%j.out
#SBATCH --error=/home/lshlt19/CNVRock/logs/saureus_ref_%j.err
...
#
# Usage:
#   sbatch hpc/build_saureus_reference.sh
...
REF="$REPO_DIR/assets/saureus_ref/USA300_extended.fasta"
DICT="${REF%.fasta}.dict"
