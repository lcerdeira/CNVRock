"""
HMM segmentation — version 02: adjusted state means for low-amplitude detection.

Identical to 01 except state 2 mean is 1.5 not 2.0, moving CN=1/CN=2
boundary from CRR=1.5 to 1.25.  Allows 7-bin genes (PM2_PM3, MDR1)
with FN p50~1.5 to be detected when self_transition<=0.75.
Used only in hmmlearn's
